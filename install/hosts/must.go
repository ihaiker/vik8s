...
func FetchNode(overwrite bool, nodes ...*ssh.Node) (ssh.Nodes, error) {
...
func Fetch(overwrite bool, args ...string) (ssh.Nodes, error) {
	...
	return FetchNode(overwrite, nodes...)
}
...
func Get(arg string) (*ssh.Node, error) {
	node := _manager.Get(arg)
	if node == nil {
...
func Gets(args []string) (ssh.Nodes, error) {
	return Fetch(false, args...)
}
